...
class SsDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        labels = torch.tensor(df['label'], dtype=torch.float)
...
class DataProcessor():
    ...
    def get_examples_from_file(self, data_dir, train_dev_test):
...
def load_and_cache_examples(args, tokenizer, train_dev_test, output_mode):
    ...
    examples_df = processor.get_examples_from_file(args.data_dir, train_dev_test)
...
def load_and_cache_features(args, task, tokenizer, train_dev_test, output_mode):
    ...
    if os.path.exists(cached_features_file):
        ...
        df = processor.get_examples_from_file(args.data_dir, train_dev_test)
